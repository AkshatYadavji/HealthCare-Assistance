...
const Signup = () => {
    ...
    const styles = {
        ...
        systemHeaderOutside: {
            ...
            justifyContent: 'center',
            gap: '10px',
            marginBottom: '24px', // Space between header and form box
            textAlign: 'center'
        },
        systemTitleOutside: {
            color: '#ffffff', 
    ...
    return (
        <div style={styles.pageContainer}>
            ...
            <div style={styles.card}>
                ...
                <p style={styles.subtitle}>Sign up to connect with your medical chatbot</p>
                ...
                <p style={styles.footer}>
                    ...
                    <Link to="/login" style={styles.link} onMouseEnter={(e) => e.target.style.textDecoration = 'underline'} onMouseLeave={(e) => e.target.style.textDecoration = 'none'}>
                        Sign In
                    </Link>
                </p>
            </div>
